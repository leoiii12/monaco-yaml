...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"plc7":[function(require,module,exports) {
(function (factory) {
  ...
  var Emitter = monaco.Emitter; // --- YAML configuration and defaults ---------
  ...
  const yamlDefaults = new LanguageServiceDefaultsImpl('yaml', diagnosticDefault); // Export API
  ...
  monaco.languages.yaml = createAPI(); // --- Registration to monaco editor ---
